...
export const pages = {
  ...
  tasks: {
    ...
    statusStuck: 'Stuck',
    statusDrafts: 'Drafts',
    draftsHint: 'Saved on this device — open to review, then create.',
    draftsEmpty: 'AVA can save several here',
  ...
  notes: {
    ...
    draftsDescription: 'Saved on this device — resume to create a page. AVA never publishes notes.',
    delete: 'Delete',
