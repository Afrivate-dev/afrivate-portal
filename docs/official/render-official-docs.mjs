...
const logoPath = path.resolve(__dirname, 'afrivate-logo-long-purple.png')
...
const docs = [
  {
    ...
    body: `
      ...
      <div class="note"><strong>Operating systems:</strong> ClickUp is AfriVate’s official internal communication channel. The AfriVate Portal is the system of record for every operational feature available within it, including tasks, weekly check-ins, goals, leave, onboarding, learning, resources, surveys, feedback, performance records, events, and people operations.</div>
      ...
      <ul>
        ...
        <li><strong>Escalation:</strong> Record risks and blockers in the relevant Portal workflow and communicate or escalate them through ClickUp.</li>
      </ul>
      ...
      <ul>
        ...
        <li>Use ClickUp to clarify work, coordinate delivery, and communicate operational decisions</li>
      ...
      <ol>
        ...
        <li>Clarification and follow-up communication handled through ClickUp</li>
      </ol>
  ...
  },
  {
    ...
    body: `
      ...
      <ul>
        <li><strong>The 4-Hour Rule:</strong> Official messages received through ClickUp must be acknowledged within four hours.</li>
        <li><strong>Official Communication Channel:</strong> ClickUp is used for internal communication, coordination, clarification, and follow-up.</li>
        <li><strong>Portal System of Record:</strong> Use the AfriVate Portal to complete and record every workflow available within it, including tasks, weekly check-ins, leave, onboarding, goals, learning submissions, surveys, feedback, policy acknowledgements, resources, events, and people operations.</li>
        <li><strong>Email:</strong> Use your @afrivate email for account access and approved external or formal correspondence. It does not replace ClickUp for internal communication.</li>
      </ul>
      ...
      <ul>
        ...
        <li>Submit your weekly report through <strong>Portal → Weekly check-in</strong>; your Team Lead will review it there.</li>
        <li>Keep assigned Portal tasks accurate by updating status, progress, hours, and blockers.</li>
      ...
      <ol>
        ...
        <li>☐ Open the SWP under <strong>Portal → Resources</strong>, read it, and complete its policy acknowledgement.</li>
        <li>☐ Join the AfriVate ClickUp workspace and your assigned team communication spaces.</li>
        <li>☐ Set up your @afrivate email for account access and approved external correspondence.</li>
        <li>☐ Agree 3–5 initial KPIs with your Team Lead and record the goals through <strong>Portal → Growth → OKRs</strong>.</li>
  ...
  },
  {
    ...
    body: `
      ...
      <ul>
        ...
        <li><strong>Honesty in Reporting:</strong> Record progress and blockers accurately in Portal tasks and Weekly check-in; use ClickUp for related communication and clarification.</li>
      ...
      <ul>
        ...
        <li><strong>Knowledge Transfer:</strong> Update unfinished tasks, shared notes, learning records, and applicable resources in the Portal, then communicate the handover and clarify ownership through ClickUp.</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Harassment-Free Zone:</strong> Submit a confidential report through <strong>Portal → People → Growth → Speak up</strong>. Use ClickUp only for necessary follow-up communication.</li>
      ...
      <ul>
        <li><strong>ClickUp:</strong> The official channel for internal communication, coordination, clarification, and follow-up.</li>
        ...
        <li><strong>Accuracy:</strong> Volunteers must keep their assigned Portal records complete and current. A ClickUp message does not replace a required Portal submission or update.</li>
      </ul>
  ...
  },
  {
    ...
    body: `
      ...
      <ul>
        ...
        <li>Team members must be reachable through ClickUp during those hours.</li>
      ...
      <h3>5.1 ClickUp: Official Internal Communication</h3>
      <p>ClickUp is AfriVate’s official channel for internal communication, coordination, clarification, follow-up, and operational escalation. Official ClickUp messages must be professional, clear, solution-oriented, and acknowledged within <strong>four (4) hours</strong> during official work days.</p>
      <p>Personal messaging channels must not replace ClickUp for official work. Email is reserved for account access, approved external correspondence, and circumstances expressly authorised by leadership.</p>
      ...
      <div class="note"><strong>System rule:</strong> ClickUp is used to communicate; the Portal is used to perform and record the corresponding workflow. A ClickUp message does not replace a required Portal submission, approval, acknowledgement, or update.</div>
      ...
      <p>Clarification and coordination occur through ClickUp; the agreed outcome must then be reflected in the Portal task.</p>
      ...
      <ul>
        ...
        <li>Communicate risks, delays, and blockers early through ClickUp.</li>
      ...
      <ol>
        <li>The Team Member communicates the issue immediately through ClickUp and records the relevant operational detail in the Portal where an applicable workflow exists.</li>
  ...
  },
  {
    ...
    body: `
      ...
      <ul>
        ...
        <li>Keep assigned work and progress current in the AfriVate Portal and use ClickUp for team communication.</li>
      </ul>
  ...
  },
  {
    ...
    body: `
      ...
      <ul>
        ...
        <li>Use Git and GitHub for collaborative delivery, keep work current in the AfriVate Portal, and use ClickUp for communication.</li>
      </ul>
  ...
  },
  {
    ...
    body: `
      ...
      <ul>
        ...
        <li>Manage assigned work through the AfriVate Portal and use ClickUp for briefs, clarification, feedback, and communication.</li>
      </ul>
  ...
  },
  {
    ...
    body: `
      ...
      <div class="note"><strong>Important:</strong> Submitting a request does not constitute approval. Staff must remain available for work until the request has been formally approved through the portal.</div>
      ...
      <ul>
        <li><strong>Complete outstanding work:</strong> Round up all due or outstanding work for the relevant week before the leave begins; or</li>
      ...
      <p>All leave requests must be made through the <strong>AfriVate Portal</strong>. Requests made only through WhatsApp, email, telephone, or verbal conversation are not official and will not be treated as approved leave.</p>
      <ol>
