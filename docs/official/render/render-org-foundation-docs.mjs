...
const signBlock = `
  <div class="sign-block">
    ...
    <div class="sign-row">
      ...
      <div class="sign-card"><div class="who">Daniel Ifeoluwasubomi Akinyemi</div><div class="role">Chief Human Resources Officer / Head of People &amp; Culture</div></div>
    </div>
  </div>`
...
const odrBody = `
  ...
  <ol>
    ...
    <li>Playbooks and handbooks (AFRI-TLOP-01, AFRI-EOH-01, AFRI-PUG-01)</li>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr><td>AFRI-PUG-01</td><td>Portal User Guide</td><td>People &amp; Culture / Product</td><td>All Team Members</td><td>In force (procedural guide; not a policy)</td></tr>
